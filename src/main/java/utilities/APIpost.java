...
//  <---------------------------------Payloads------------------------------------------------------->
        ...
        String hashkey = GenerateHash.hash(accesskey);
...
//  <--------------------------------BASE64 encode------------------------------------------------------->  
        String base64encode = base64.base64Encoder(signedsignerinfo);
...
//  <--------------------------------URLEncode------------------------------------------------------->        
        String urlEncodedRequest = UrlEncoder.urlEncoder(signedXML);
